...
# RUN TIMESTAMP=$(cat /timestamp.txt) && \
#     sl-python config --appname Python-App-Todo-List --branchname sealights --buildname "PATL-$TIMESTAMP" --exclude '/app/tests/*','/app/sealights-integration-examples/*' --workspacepath /app --tokenfile /app/token.txt
...
# RUN git clone https://github.com/ascerra/sealights-integration-examples.git
